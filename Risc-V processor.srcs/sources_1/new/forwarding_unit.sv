...
module Forward (
    ...
    input logic [4:0] ex_mem_rd, mem_wb_rd, ex2_reg_dest,
    ...
    always_comb begin
        ...
        ex2_rs1_match = (ex2_reg_write && (ex2_reg_dest != 5'b0) && (id_ex_rs1 == ex2_reg_dest));
        ex2_rs2_match = (ex2_reg_write && (ex2_reg_dest != 5'b0) && (id_ex_rs2 == ex2_reg_dest));
        ex2_rs3_match = (ex2_reg_write && (ex2_reg_dest != 5'b0) && (id_ex_rs3 == ex2_reg_dest));
