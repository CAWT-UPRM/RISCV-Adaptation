...
#
# Script generated by Vivado on Sat Jun 14 16:48:05 -0400 2025
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xpm -L blk_mem_gen_v8_4_9 -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot SC_stimulus xil_defaultlib.SC_stimulus xil_defaultlib.glbl -log elaborate.log
}
