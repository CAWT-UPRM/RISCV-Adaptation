...
#
# Script generated by Vivado on Sat Jun 14 09:46:35 -0400 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : DM_stimulus.sh
...
#
# Usage        : DM_stimulus.sh
#                DM_stimulus.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                DM_stimulus.sh [-reset_run]
#                DM_stimulus.sh [-reset_log]
#                DM_stimulus.sh [-help]
#
...
# script info
echo -e "DM_stimulus.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./DM_stimulus.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xpm -L blk_mem_gen_v8_4_9 -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot DM_stimulus xil_defaultlib.DM_stimulus xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim DM_stimulus -key {Behavioral:sim_1:Functional:DM_stimulus} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb DM_stimulus.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./DM_stimulus.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: DM_stimulus.sh [-help]\n\
Usage: DM_stimulus.sh [-step]\n\
Usage: DM_stimulus.sh [-lib_map_path]\n\
Usage: DM_stimulus.sh [-reset_run]\n\
Usage: DM_stimulus.sh [-reset_log]\n\
Usage: DM_stimulus.sh [-keep_index]\n\
Usage: DM_stimulus.sh [-noclean_files]\n\n\
