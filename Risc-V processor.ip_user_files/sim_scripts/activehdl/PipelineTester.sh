...
#                script (type 'PipelineTester.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/pizar/git_pipelined_datapath/git_pipelined_datapath.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
