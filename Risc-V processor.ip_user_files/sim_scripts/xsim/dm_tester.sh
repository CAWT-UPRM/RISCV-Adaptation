...
#
# Script generated by Vivado on Tue Jun 24 12:41:35 -0400 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : dm_tester.sh
...
#
# Usage        : dm_tester.sh
#                dm_tester.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                dm_tester.sh [-reset_run]
#                dm_tester.sh [-reset_log]
#                dm_tester.sh [-help]
#
...
# script info
echo -e "dm_tester.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./dm_tester.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_9 -L uvm -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot dm_tester xil_defaultlib.dm_tester xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim dm_tester -key {Behavioral:sim_1:Functional:dm_tester} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb dm_tester.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./dm_tester.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: dm_tester.sh [-help]\n\
Usage: dm_tester.sh [-step]\n\
Usage: dm_tester.sh [-lib_map_path]\n\
Usage: dm_tester.sh [-reset_run]\n\
Usage: dm_tester.sh [-reset_log]\n\
Usage: dm_tester.sh [-keep_index]\n\
Usage: dm_tester.sh [-noclean_files]\n\n\
