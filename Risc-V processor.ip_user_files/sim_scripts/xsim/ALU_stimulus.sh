...
#
# Script generated by Vivado on Thu Jun 12 13:43:52 -0400 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : ALU_stimulus.sh
...
#
# Usage        : ALU_stimulus.sh
#                ALU_stimulus.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ALU_stimulus.sh [-reset_run]
#                ALU_stimulus.sh [-reset_log]
#                ALU_stimulus.sh [-help]
#
...
# script info
echo -e "ALU_stimulus.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ALU_stimulus.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xpm -L xbip_dsp48_wrapper_v3_0_6 -L xbip_utils_v3_0_14 -L xbip_pipe_v3_0_10 -L dsp_macro_v1_0_7 -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot ALU_stimulus xil_defaultlib.ALU_stimulus xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ALU_stimulus -key {Behavioral:sim_1:Functional:ALU_stimulus} -tclbatch cmd.tcl -log simulate.log
}
...
map_local_libs()
{
  ...
  local_libs=(xpm xbip_dsp48_wrapper_v3_0_6 xbip_utils_v3_0_14 xbip_pipe_v3_0_10 dsp_macro_v1_0_7)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ALU_stimulus.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ALU_stimulus.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ALU_stimulus.sh [-help]\n\
Usage: ALU_stimulus.sh [-step]\n\
Usage: ALU_stimulus.sh [-lib_map_path]\n\
Usage: ALU_stimulus.sh [-reset_run]\n\
Usage: ALU_stimulus.sh [-reset_log]\n\
Usage: ALU_stimulus.sh [-keep_index]\n\
Usage: ALU_stimulus.sh [-noclean_files]\n\n\
