...
#
# Script generated by Vivado on Mon Jun 16 12:47:50 -0400 2025
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xbip_dsp48_wrapper_v3_0_6 -L xbip_utils_v3_0_14 -L xbip_pipe_v3_0_10 -L dsp_macro_v1_0_7 -L uvm -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ALU_stimulus xil_defaultlib.ALU_stimulus xil_defaultlib.glbl -log elaborate.log
}
