...
#
# Script generated by Vivado on Sun Jun 22 15:07:40 -0400 2025
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_9 -L xbip_dsp48_wrapper_v3_0_6 -L xbip_utils_v3_0_14 -L xbip_pipe_v3_0_10 -L dsp_macro_v1_0_7 -L uvm -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot SC_stimulus xil_defaultlib.SC_stimulus xil_defaultlib.glbl -log elaborate.log
}
