...
#
# Script generated by Vivado on Fri Jun 13 00:36:24 -0400 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : SC_stimulus.sh
...
#
# Usage        : SC_stimulus.sh
#                SC_stimulus.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                SC_stimulus.sh [-reset_run]
#                SC_stimulus.sh [-reset_log]
#                SC_stimulus.sh [-help]
#
...
# script info
echo -e "SC_stimulus.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./SC_stimulus.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xpm -L blk_mem_gen_v8_4_9 -L xbip_dsp48_wrapper_v3_0_6 -L xbip_utils_v3_0_14 -L xbip_pipe_v3_0_10 -L dsp_macro_v1_0_7 -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot SC_stimulus xil_defaultlib.SC_stimulus xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim SC_stimulus -key {Behavioral:sim_1:Functional:SC_stimulus} -tclbatch cmd.tcl -log simulate.log
}
...
map_local_libs()
{
  ...
  local_libs=(xpm blk_mem_gen_v8_4_9 xbip_dsp48_wrapper_v3_0_6 xbip_utils_v3_0_14 xbip_pipe_v3_0_10 dsp_macro_v1_0_7)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb SC_stimulus.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./SC_stimulus.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: SC_stimulus.sh [-help]\n\
Usage: SC_stimulus.sh [-step]\n\
Usage: SC_stimulus.sh [-lib_map_path]\n\
Usage: SC_stimulus.sh [-reset_run]\n\
Usage: SC_stimulus.sh [-reset_log]\n\
Usage: SC_stimulus.sh [-keep_index]\n\
Usage: SC_stimulus.sh [-noclean_files]\n\n\
